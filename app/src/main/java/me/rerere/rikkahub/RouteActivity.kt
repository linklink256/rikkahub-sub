...
import me.rerere.rikkahub.ui.pages.imggen.ImageGalleryPage
        ...
        LaunchedEffect(tts) {
            eventBus.events.collect { event ->
                when (event) {
                    ...
                    is AppEvent.OpenUsageAccessSettings -> openUsageAccessSettings()
                }
            }
        }
                    ...
                    NavDisplay(
                        ...
                        entryProvider = entryProvider {
                            ...
                            entry<Screen.AssistantSubagentProfile> { key ->
                                AssistantSubagentProfilePage(key.id, key.profileName)
                            }
...
sealed interface Screen : NavKey {
    ...
    @Serializable
    data class AssistantSubagentProfile(val id: String, val profileName: String) : Screen
    ...
    @Serializable
    data object ImageGallery : Screen
